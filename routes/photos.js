	    ...
	    if (!error && response.statusCode == 200) {
			...
			twitterClient.post('media/upload', { media: photoboothPic }, function (err, media, response) {
			  ...
			  if(err){
					...
					var status = { 
						status: twitid + ' Check out your #EMC #OpenStackSummit Photo Booth pictures at http://photobooth.emccode.com/photos/' + req.params.uniqueurl + ' #DevOpsEMC',
